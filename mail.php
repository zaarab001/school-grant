            ...
            <section class="panel">
              <div class="panel-body">
                ...
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li class="active"><a href=""> <i class="fa fa-user"></i> Memunat Manzuma</a></li>
                  <li><a href="#"> <i class="fa fa-envelope-o"></i> zaarab001@gmail.com</a></li>
                  <li><a href="#"> <i class="fa fa-phone"></i> +2348160730725</a></li>
                  <li><a href="#"> <i class="fa fa-file-text-o"></i> Drafts</a></a>
                  </li>
